...
| Terminal window | `<M-4>` | `<Cmd>2ToggleTerm dir=CWD direction=float<CR>` |
| Run window | `<M-3>` | `<Cmd>1ToggleTerm dir=CWD direction=float<CR>` |
...
|  | `<Plug>(VM-Find-Subword-Under)` | `<SNR>17_Visual('under')` |
...
|  | `<Plug>(VM-Visual-All)` | `<SNR>17_Visual('all')` |
