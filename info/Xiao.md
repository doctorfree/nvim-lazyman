...
|  | <Plug>(vsnip-cut-text) | :set operatorfunc=<SNR>20_vsnip_cut_text_normal<CR>g@ |
|  | <Plug>(vsnip-select-text) | :set operatorfunc=<SNR>20_vsnip_select_text_normal<CR>g@ |
...
|  | <Plug>(vsnip-cut-text) | :<C-U>call <SNR>14_vsnip_visual_text(visualmode())<CR>gv"_c |
|  | <Plug>(vsnip-select-text) | :<C-U>call <SNR>14_vsnip_visual_text(visualmode())<CR>gv |
