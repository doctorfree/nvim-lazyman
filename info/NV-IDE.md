...
|  | <Plug>(vsnip-cut-text) | :set operatorfunc=<SNR>19_vsnip_cut_text_normal<CR>g@ |
|  | <Plug>(vsnip-select-text) | :set operatorfunc=<SNR>19_vsnip_select_text_normal<CR>g@ |
|  | <Plug>CapsLockDisable | :<C-U>call <SNR>16_disable('i')<CR> |
|  | <Plug>CapsLockEnable | :<C-U>call <SNR>16_enable('i',1)<CR> |
|  | <Plug>CapsLockToggle | :<C-U>call <SNR>16_toggle('i',1)<CR> |
