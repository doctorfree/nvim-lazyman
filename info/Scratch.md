...
|  | <Plug>(unimpaired-xml-decode-line) | <SNR>19_TransformSetup("xml_decode")."_" |
|  | <Plug>(unimpaired-xml-decode) | <SNR>19_TransformSetup("xml_decode") |
|  | <Plug>unimpaired_line_xml_decode | <SNR>19_TransformSetup("xml_decode")."_" |
|  | <Plug>unimpaired_xml_decode | <SNR>19_TransformSetup("xml_decode") |
|  | <Plug>(unimpaired-xml-encode-line) | <SNR>19_TransformSetup("xml_encode")."_" |
|  | <Plug>(unimpaired-xml-encode) | <SNR>19_TransformSetup("xml_encode") |
|  | <Plug>unimpaired_line_xml_encode | <SNR>19_TransformSetup("xml_encode")."_" |
|  | <Plug>unimpaired_xml_encode | <SNR>19_TransformSetup("xml_encode") |
|  | <Plug>(unimpaired-url-decode-line) | <SNR>19_TransformSetup("url_decode")."_" |
|  | <Plug>(unimpaired-url-decode) | <SNR>19_TransformSetup("url_decode") |
|  | <Plug>unimpaired_line_url_decode | <SNR>19_TransformSetup("url_decode")."_" |
|  | <Plug>unimpaired_url_decode | <SNR>19_TransformSetup("url_decode") |
|  | <Plug>(unimpaired-url-encode-line) | <SNR>19_TransformSetup("url_encode")."_" |
|  | <Plug>(unimpaired-url-encode) | <SNR>19_TransformSetup("url_encode") |
|  | <Plug>unimpaired_line_url_encode | <SNR>19_TransformSetup("url_encode")."_" |
|  | <Plug>unimpaired_url_encode | <SNR>19_TransformSetup("url_encode") |
|  | <Plug>(unimpaired-string-decode-line) | <SNR>19_TransformSetup("string_decode")."_" |
|  | <Plug>(unimpaired-string-decode) | <SNR>19_TransformSetup("string_decode") |
|  | <Plug>unimpaired_line_string_decode | <SNR>19_TransformSetup("string_decode")."_" |
|  | <Plug>unimpaired_string_decode | <SNR>19_TransformSetup("string_decode") |
|  | <Plug>(unimpaired-string-encode-line) | <SNR>19_TransformSetup("string_encode")."_" |
|  | <Plug>(unimpaired-string-encode) | <SNR>19_TransformSetup("string_encode") |
|  | <Plug>unimpaired_line_string_encode | <SNR>19_TransformSetup("string_encode")."_" |
|  | <Plug>unimpaired_string_encode | <SNR>19_TransformSetup("string_encode") |
|  | <Plug>unimpairedPutBelow | :call <SNR>19_putline(']p', 'below')<CR> |
|  | <Plug>unimpairedPutAbove | :call <SNR>19_putline('[p', 'above')<CR> |
|  | <Plug>(unimpaired-put-below-reformat) | :<C-U>call <SNR>19_putline(v:count1 . ']p', 'Below')<CR>='] |
|  | <Plug>(unimpaired-put-above-reformat) | :<C-U>call <SNR>19_putline(v:count1 . '[p', 'Above')<CR>='] |
|  | <Plug>(unimpaired-put-below-leftward) | :<C-U>call <SNR>19_putline(v:count1 . ']p', 'Below')<CR><lt>'] |
|  | <Plug>(unimpaired-put-above-leftward) | :<C-U>call <SNR>19_putline(v:count1 . '[p', 'Above')<CR><lt>'] |
|  | <Plug>(unimpaired-put-below-rightward) | :<C-U>call <SNR>19_putline(v:count1 . ']p', 'Below')<CR>>'] |
|  | <Plug>(unimpaired-put-above-rightward) | :<C-U>call <SNR>19_putline(v:count1 . '[p', 'Above')<CR>>'] |
|  | <Plug>(unimpaired-put-below) | :call <SNR>19_putline(']p', 'below')<CR> |
|  | <Plug>(unimpaired-put-above) | :call <SNR>19_putline('[p', 'above')<CR> |
|  | <Plug>(unimpaired-toggle)p | :<C-U>call <SNR>19_SetupPaste()<CR>0C |
|  | <Plug>(unimpaired-disable)p | :<C-U>call <SNR>19_SetupPaste()<CR>o |
|  | <Plug>(unimpaired-enable)p | :<C-U>call <SNR>19_SetupPaste()<CR>O |
|  | <Plug>(unimpaired-paste) | :<C-U>call <SNR>19_SetupPaste()<CR> |
|  | <Plug>unimpairedPaste | :call <SNR>19_SetupPaste()<CR> |
|  | <Plug>(unimpaired-toggle)t | :<C-U>set colorcolumn=<C-R>=<SNR>19_ColorColumn(!empty(&cc))<CR><CR> |
|  | <Plug>(unimpaired-disable)t | :<C-U>set colorcolumn=<C-R>=<SNR>19_ColorColumn(1)<CR><CR> |
|  | <Plug>(unimpaired-enable)t | :<C-U>set colorcolumn=<C-R>=<SNR>19_ColorColumn(0)<CR><CR> |
|  | <Plug>(unimpaired-toggle)+ | :<C-U>set <C-R>=<SNR>19_CursorOptions()<CR><CR> |
|  | <Plug>(unimpaired-disable)+ | :<C-U>set nocursorline nocursorcolumn<CR> |
|  | <Plug>(unimpaired-enable)+ | :<C-U>set cursorline cursorcolumn<CR> |
|  | <Plug>(unimpaired-toggle)x | :<C-U>set <C-R>=<SNR>19_CursorOptions()<CR><CR> |
...
|  | <Plug>(unimpaired-toggle)z | :<C-U>setlocal <C-R>=<SNR>19_Toggle("spell")<CR><CR> |
|  | <Plug>(unimpaired-disable)z | :<C-U>setlocal nospell<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)z | :<C-U>setlocal spell<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)w | :<C-U>setlocal <C-R>=<SNR>19_Toggle("wrap")<CR><CR> |
|  | <Plug>(unimpaired-disable)w | :<C-U>setlocal nowrap<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)w | :<C-U>setlocal wrap<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)s | :<C-U>setlocal <C-R>=<SNR>19_Toggle("spell")<CR><CR> |
|  | <Plug>(unimpaired-disable)s | :<C-U>setlocal nospell<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)s | :<C-U>setlocal spell<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)r | :<C-U>setlocal <C-R>=<SNR>19_Toggle("relativenumber")<CR><CR> |
|  | <Plug>(unimpaired-disable)r | :<C-U>setlocal norelativenumber<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)r | :<C-U>setlocal relativenumber<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)n | :<C-U>setlocal <C-R>=<SNR>19_Toggle("number")<CR><CR> |
|  | <Plug>(unimpaired-disable)n | :<C-U>setlocal nonumber<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)n | :<C-U>setlocal number<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)l | :<C-U>setlocal <C-R>=<SNR>19_Toggle("list")<CR><CR> |
|  | <Plug>(unimpaired-disable)l | :<C-U>setlocal nolist<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)l | :<C-U>setlocal list<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)i | :<C-U>set <C-R>=<SNR>19_Toggle("ignorecase")<CR><CR> |
|  | <Plug>(unimpaired-disable)i | :<C-U>set noignorecase<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)i | :<C-U>set ignorecase<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)h | :<C-U>set <C-R>=<SNR>19_Toggle("hlsearch")<CR><CR> |
|  | <Plug>(unimpaired-disable)h | :<C-U>set nohlsearch<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)h | :<C-U>set hlsearch<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
...
|  | <Plug>(unimpaired-toggle)| | :<C-U>setlocal <C-R>=<SNR>19_Toggle("cursorcolumn")<CR><CR> |
|  | <Plug>(unimpaired-disable)| | :<C-U>setlocal nocursorcolumn<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)| | :<C-U>setlocal cursorcolumn<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)u | :<C-U>setlocal <C-R>=<SNR>19_Toggle("cursorcolumn")<CR><CR> |
|  | <Plug>(unimpaired-disable)u | :<C-U>setlocal nocursorcolumn<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)u | :<C-U>setlocal cursorcolumn<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)_ | :<C-U>setlocal <C-R>=<SNR>19_Toggle("cursorline")<CR><CR> |
|  | <Plug>(unimpaired-disable)_ | :<C-U>setlocal nocursorline<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)_ | :<C-U>setlocal cursorline<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)- | :<C-U>setlocal <C-R>=<SNR>19_Toggle("cursorline")<CR><CR> |
|  | <Plug>(unimpaired-disable)- | :<C-U>setlocal nocursorline<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)- | :<C-U>setlocal cursorline<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-toggle)c | :<C-U>setlocal <C-R>=<SNR>19_Toggle("cursorline")<CR><CR> |
|  | <Plug>(unimpaired-disable)c | :<C-U>setlocal nocursorline<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
|  | <Plug>(unimpaired-enable)c | :<C-U>setlocal cursorline<C-R>=<SNR>19_StatuslineRefresh()<CR><CR> |
...
|  | <Plug>unimpairedMoveSelectionDown | :<C-U>call <SNR>19_MoveSelectionDown(v:count1)<CR> |
|  | <Plug>unimpairedMoveSelectionUp | :<C-U>call <SNR>19_MoveSelectionUp(v:count1)<CR> |
|  | <Plug>unimpairedMoveDown | :<C-U>call <SNR>19_Move('+',v:count1,'down')<CR> |
|  | <Plug>unimpairedMoveUp | :<C-U>call <SNR>19_Move('--',v:count1,'up')<CR> |
|  | <Plug>(unimpaired-move-selection-down) | :<C-U>call <SNR>19_MoveSelectionDown(v:count1)<CR> |
|  | <Plug>(unimpaired-move-selection-up) | :<C-U>call <SNR>19_MoveSelectionUp(v:count1)<CR> |
|  | <Plug>(unimpaired-move-down) | :<C-U>call <SNR>19_Move('+',v:count1,'down')<CR> |
|  | <Plug>(unimpaired-move-up) | :<C-U>call <SNR>19_Move('--',v:count1,'up')<CR> |
|  | <Plug>unimpairedBlankDown | :<C-U>exe <SNR>19_BlankDown()<CR> |
|  | <Plug>unimpairedBlankUp | :<C-U>exe <SNR>19_BlankUp()<CR> |
|  | <Plug>(unimpaired-blank-down) | :<C-U>exe <SNR>19_BlankDown()<CR> |
|  | <Plug>(unimpaired-blank-up) | :<C-U>exe <SNR>19_BlankUp()<CR> |
|  | <Plug>unimpairedContextNext | :<C-U>call <SNR>19_Context(0)<CR> |
|  | <Plug>unimpairedContextPrevious | :<C-U>call <SNR>19_Context(1)<CR> |
|  | <Plug>(unimpaired-context-next) | :<C-U>call <SNR>19_Context(0)<CR> |
|  | <Plug>(unimpaired-context-previous) | :<C-U>call <SNR>19_Context(1)<CR> |
|  | <Plug>unimpairedDirectoryPrevious | :<C-U>execute <SNR>19_PreviousFileEntry(v:count1)<CR> |
|  | <Plug>unimpairedDirectoryNext | :<C-U>execute <SNR>19_NextFileEntry(v:count1)<CR> |
|  | <Plug>(unimpaired-directory-previous) | :<C-U>execute <SNR>19_PreviousFileEntry(v:count1)<CR> |
|  | <Plug>(unimpaired-directory-next) | :<C-U>execute <SNR>19_NextFileEntry(v:count1)<CR> |
...
|  | <Plug>YSurround | <SNR>6_opfunc2('setup') |
|  | <Plug>Ysurround | <SNR>6_opfunc('setup') |
|  | <Plug>YSsurround | <SNR>6_opfunc2('setup').'_' |
|  | <Plug>Yssurround | '^'.v:count1.<SNR>6_opfunc('setup').'g_' |
|  | <Plug>CSurround | :<C-U>call <SNR>6_changesurround(1)<CR> |
|  | <Plug>Csurround | :<C-U>call <SNR>6_changesurround()<CR> |
|  | <Plug>Dsurround | :<C-U>call <SNR>6_dosurround(<SNR>6_inputtarget())<CR> |
|  | <Plug>SurroundRepeat | . |
...
|  | <Plug>(matchup-Z%) | <SNR>20_(matchup-Z%) |
|  | <SNR>20_(matchup-Z%) | :<C-U>call matchup#motion#jump_inside_prev(1)<CR> |
|  | <Plug>(matchup-z%) | <SNR>20_(matchup-z%) |
|  | <SNR>20_(matchup-z%) | :<C-U>call matchup#motion#jump_inside(1)<CR> |
|  | <Plug>(matchup-[%) | <SNR>20_(matchup-[%) |
|  | <Plug>(matchup-]%) | <SNR>20_(matchup-]%) |
|  | <SNR>20_(matchup-[%) | :<C-U>call matchup#motion#find_unmatched(1, 0)<CR> |
|  | <SNR>20_(matchup-]%) | :<C-U>call matchup#motion#find_unmatched(1, 1)<CR> |
|  | <Plug>(matchup-g%) | <SNR>20_(matchup-g%) |
|  | <SNR>20_(matchup-g%) | :<C-U>call matchup#motion#find_matching_pair(1, 0)<CR> |
|  | <Plug>(matchup-%) | <SNR>20_(matchup-%) |
|  | <SNR>20_(matchup-%) | :<C-U>call matchup#motion#find_matching_pair(1, 1)<CR> |
|  | <Plug>luasnip-expand-repeat | <Cmd>lua require'luasnip'.expand_repeat()<CR> |
|  | <Plug>luasnip-delete-check | <Cmd>lua require'luasnip'.unlink_current_if_deleted()<CR> |
|  | <Plug>(leap-backward-x) |  |
|  | <Plug>(leap-forward-x) |  |
...
|  | <Plug>unimpairedContextNext | :<C-U>exe 'normal! gv'|call <SNR>7_Context(0)<CR> |
|  | <Plug>unimpairedContextPrevious | :<C-U>exe 'normal! gv'|call <SNR>7_Context(1)<CR> |
|  | <Plug>(unimpaired-context-next) | :<C-U>exe 'normal! gv'|call <SNR>7_Context(0)<CR> |
|  | <Plug>(unimpaired-context-previous) | :<C-U>exe 'normal! gv'|call <SNR>7_Context(1)<CR> |
