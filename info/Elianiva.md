...
|  | `<Plug>(EasyAlignOperator)` | `:set opfunc=<SNR>29_easy_align_op<CR>g@` |
|  | `<Plug>(EasyAlignRepeat)` | `:call <SNR>29_easy_align_repeat()<CR>` |
|  | `<Plug>(LiveEasyAlign)` | `:set opfunc=<SNR>29_live_easy_align_op<CR>g@` |
|  | `<Plug>(EasyAlign)` | `:set opfunc=<SNR>29_easy_align_op<CR>g@` |
...
|  | `<Plug>(matchup-Z%)` | `<SNR>13_(matchup-Z%)` |
|  | `<SNR>13_(matchup-Z%)` | `:<C-U>call matchup#motion#jump_inside_prev(1)<CR>` |
|  | `<Plug>(matchup-z%)` | `<SNR>13_(matchup-z%)` |
|  | `<SNR>13_(matchup-z%)` | `:<C-U>call matchup#motion#jump_inside(1)<CR>` |
|  | `<Plug>(matchup-[%)` | `<SNR>13_(matchup-[%)` |
|  | `<Plug>(matchup-]%)` | `<SNR>13_(matchup-]%)` |
|  | `<SNR>13_(matchup-[%)` | `:<C-U>call matchup#motion#find_unmatched(1, 0)<CR>` |
|  | `<SNR>13_(matchup-]%)` | `:<C-U>call matchup#motion#find_unmatched(1, 1)<CR>` |
|  | `<Plug>(matchup-g%)` | `<SNR>13_(matchup-g%)` |
|  | `<SNR>13_(matchup-g%)` | `:<C-U>call matchup#motion#find_matching_pair(1, 0)<CR>` |
|  | `<Plug>(matchup-%)` | `<SNR>13_(matchup-%)` |
|  | `<SNR>13_(matchup-%)` | `:<C-U>call matchup#motion#find_matching_pair(1, 1)<CR>` |
