...
```
n  ,cr         *@<Lua 1134: ~/.local/share/nvim/runtime/lua/vim/lsp/buf.lua:271>
                 Rename
 Last set from Lua
n  ,ghD        *@<Lua 950: ~/.config/nvim-Lazyman/lua/plugins/gitsigns.lua:32>
                 Diff This ~
 Last set from Lua
n  ,ghd        *@<Lua 1157: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:1052>
                 Diff This
 Last set from Lua
n  ,ghb        *@<Lua 954: ~/.config/nvim-Lazyman/lua/plugins/gitsigns.lua:30>
                 Blame Line
 Last set from Lua
n  ,ghp        *@<Lua 1158: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:708>
                 Preview Hunk
 Last set from Lua
n  ,ghR        *@<Lua 1159: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:401>
                 Reset Buffer
 Last set from Lua
n  ,ghu        *@<Lua 1160: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/async.lua:192>
                 Undo Stage Hunk
 Last set from Lua
n  ,ghS        *@<Lua 1141: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/async.lua:192>
                 Stage Buffer
 Last set from Lua
...
n  ,ghs        *@:Gitsigns stage_hunk<CR>
                 Stage Hunk
 Last set from Lua
n  ,gd         *@<Lua 246: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:213>
                 Toggle deleted
 Last set from Lua
n  ,hD         *@<Lua 285: ~/.config/nvim-Lazyman/lua/config/lsp/gitsigns.lua:44>
                 Diff this ~
 Last set from Lua
n  ,hd         *@<Lua 282: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:1052>
                 Diff this
 Last set from Lua
n  ,gb         *@<Lua 279: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:195>
                 Toggle line blame
 Last set from Lua
n  ,hb         *@<Lua 271: ~/.config/nvim-Lazyman/lua/config/lsp/gitsigns.lua:39>
                 Blame line
 Last set from Lua
n  ,hp         *@<Lua 300: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:708>
                 Preview hunk
 Last set from Lua
n  ,hR         *@<Lua 297: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:401>
                 Reset buffer
 Last set from Lua
n  ,hu         *@<Lua 431: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/async.lua:192>
                 Undo stage hunk
 Last set from Lua
n  ,hS         *@<Lua 294: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/async.lua:192>
                 Stage buffer
 Last set from Lua
...
n  ,rn         *@<Cmd>lua require('renamer').rename()<CR>
 Last set from Lua
v  ,ca         *@<Lua 288: ~/.local/share/nvim/runtime/lua/vim/lsp/buf.lua:758>
                 Code Action
 Last set from Lua
n  ,ca         *@<Lua 291: ~/.local/share/nvim/runtime/lua/vim/lsp/buf.lua:758>
                 Code Action
 Last set from Lua
n  ,cf         *@<Lua 270: ~/.config/nvim-Lazyman/lua/config/lsp/format.lua:21>
                 Format Document
 Last set from Lua
n  ,cd         *@<Lua 258: ~/.local/share/nvim/runtime/lua/vim/diagnostic.lua:1272>
                 Line Diagnostics
 Last set from Lua
n  ,cl         *@<Cmd>LspInfo<CR>
                 Lsp Info
 Last set from Lua
v  ,cf         *@<Lua 565: ~/.config/nvim-Lazyman/lua/config/lsp/format.lua:21>
                 Format Range
 Last set from Lua
...
n  K           *@<Cmd>lua vim.lsp.buf.hover()<CR>
 Last set from Lua
n  [h          *@<Lua 1136: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:625>
                 Prev Hunk
 Last set from Lua
n  [c          *@<Lua 521: ~/.config/nvim-Lazyman/lua/config/lsp/gitsigns.lua:22>
 Last set from Lua
n  [e          *@<Lua 557: ~/.config/nvim-Lazyman/lua/config/lsp/keymaps.lua:87>
                 Prev Error
 Last set from Lua
n  [w          *@<Lua 1112: ~/.config/nvim-Lazyman/lua/config/lsp/keymaps.lua:87>
                 Prev Warning
 Last set from Lua
n  [d          *@<Cmd>lua vim.diagnostic.goto_prev({buffer=0})<CR>
 Last set from Lua
x  [[          *@:<C-U>exe "normal! gv"|call search('\%(^#\{1,5\}\s\+\S\|^\S.*\n^[=-]\+$\)', "bsW")<CR>
 Last set from ~/.local/share/nvim/runtime/ftplugin/markdown.vim line 32
n  [[          *@<Lua 642: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:188>
                 Prev Reference
 Last set from Lua
n  ]h          *@<Lua 683: ~/.local/share/nvim-Lazyman/lazy/gitsigns.nvim/lua/gitsigns/actions.lua:613>
                 Next Hunk
 Last set from Lua
n  ]c          *@<Lua 605: ~/.config/nvim-Lazyman/lua/config/lsp/gitsigns.lua:12>
 Last set from Lua
n  ]e          *@<Lua 552: ~/.config/nvim-Lazyman/lua/config/lsp/keymaps.lua:87>
                 Next Error
 Last set from Lua
n  ]w          *@<Lua 561: ~/.config/nvim-Lazyman/lua/config/lsp/keymaps.lua:87>
                 Next Warning
 Last set from Lua
n  ]d          *@<Cmd>lua vim.diagnostic.goto_next({buffer=0})<CR>
 Last set from Lua
x  ]]          *@:<C-U>exe "normal! gv"|call search('\%(^#\{1,5\}\s\+\S\|^\S.*\n^[=-]\+$\)', "sW")<CR>
 Last set from ~/.local/share/nvim/runtime/ftplugin/markdown.vim line 33
n  ]]          *@<Lua 641: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:188>
                 Next Reference
 Last set from Lua
x  ac          *@<Lua 640: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @class.outer
 Last set from Lua
o  ac          *@<Lua 639: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @class.outer
 Last set from Lua
x  ab          *@<Lua 636: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @block.outer
 Last set from Lua
o  ab          *@<Lua 635: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @block.outer
 Last set from Lua
...
n  gi          *@<Cmd>lua vim.lsp.buf.implementation()<CR>
 Last set from Lua
n  gD          *@<Lua 1125: ~/.local/share/nvim/runtime/lua/vim/lsp/buf.lua:64>
                 Goto Declaration
 Last set from Lua
...
o  ih          *@:<C-U>Gitsigns select_hunk<CR>
 Last set from Lua
x  ib          *@<Lua 638: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @block.inner
 Last set from Lua
o  ib          *@<Lua 637: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @block.inner
 Last set from Lua
x  ic          *@<Lua 633: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @class.inner
 Last set from Lua
o  ic          *@<Lua 632: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter-textobjects/lua/nvim-treesitter/textobjects/select.lua:187>
                 Select textobject @class.inner
 Last set from Lua
...
x  <C-Space>   *@:lua require'nvim-treesitter.incremental_selection'.node_incremental()<CR>
 ...
 Last set from Lua
n  <C-Space>   *@<Lua 630: ~/.local/share/nvim-Lazyman/lazy/nvim-treesitter/lua/nvim-treesitter/incremental_selection.lua:14>
                 Start selecting nodes with nvim-treesitter
 Last set from Lua
s  <Tab>       * <Lua 1016: ~/.local/share/nvim-Lazyman/lazy/nvim-cmp/lua/cmp/utils/keymap.lua:127>
...
x  *           * y/\V<C-R>"<CR>
                 Nvim builtin
 Last set from Lua
n  ,un         * <Lua 155: ~/.config/nvim-Lazyman/lua/plugins/ui.lua:146>
                 Delete all Notifications
 Last set from Lua
x  ,pÞ         * <Nop>
 Last set from Lua
v  ,pe         * <Lua 234: ~/.config/nvim-Lazyman/lua/plugins/chatgpt.lua:127>
...
n  ,ww         * <C-W>p
                 Other window
 Last set from Lua
n  ,fT         * <Lua 747: ~/.config/nvim-Lazyman/lua/keymaps.lua:176>
                 Terminal (cwd)
 Last set from Lua
n  ,ft         * <Lua 748: ~/.config/nvim-Lazyman/lua/keymaps.lua:175>
                 Terminal (root dir)
 Last set from Lua
n  ,ui         * <Lua 749: ~/.local/share/nvim/runtime/lua/vim/_inspector.lua:143>
                 Inspect Pos
 Last set from Lua
n  ,qq         * <Cmd>qa<CR>
                 Quit all
 Last set from Lua
n  ,gi         * <Lua 750: ~/.local/share/nvim-Lazyman/lazy/gitignore.nvim/lua/gitignore/init.lua:103>
                 Generate .gitignore
 Last set from Lua
n  ,snl        * <Lua 133: ~/.config/nvim-Lazyman/lua/plugins/ui.lua:76>
                 Noice Last Message
 Last set from Lua
n  ,snh        * <Lua 131: ~/.config/nvim-Lazyman/lua/plugins/ui.lua:77>
                 Noice History
 Last set from Lua
n  ,sna        * <Lua 130: ~/.config/nvim-Lazyman/lua/plugins/ui.lua:78>
                 Noice All
 Last set from Lua
n  ,<Space>    * <Lua 124: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Find Files (root dir)
 Last set from Lua
...
n  ,ss         * <Cmd>Telescope grep_string<CR>
                 Text under cursor
 Last set from Lua
n  ,fF         * <Lua 117: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Find Files (cwd)
 Last set from Lua
...
n  ,sd         * <Cmd>Telescope diagnostics<CR>
                 Diagnostics
 Last set from Lua
n  ,sg         * <Lua 99: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Grep (root dir)
 Last set from Lua
n  ,sG         * <Lua 98: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Grep (cwd)
 Last set from Lua
...
n  ,sR         * <Cmd>Telescope regiesters<CR>
                 Registers
 Last set from Lua
n  ,sw         * <Lua 87: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Word (root dir)
 Last set from Lua
n  ,sW         * <Lua 86: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Word (cwd)
 Last set from Lua
n  ,uC         * <Lua 85: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Colorscheme with preview
 Last set from Lua
n  ,,          * <Cmd>Telescope buffers show_all_buffers=true<CR>
                 Switch Buffer
 Last set from Lua
n  ,/          * <Lua 60: ~/.config/nvim-Lazyman/lua/utils/utils.lua:151>
                 Find in Files (Grep)
 Last set from Lua
n  ,:          * <Cmd>Telescope command_history<CR>
                 Command History
 Last set from Lua
n  ,gG         * <Lua 782: ~/.config/nvim-Lazyman/lua/keymaps.lua:160>
                 Lazygit (cwd)
 Last set from Lua
n  ,uc         * <Lua 783: ~/.config/nvim-Lazyman/lua/keymaps.lua:154>
                 Toggle Conceal
 Last set from Lua
n  ,ul         * <Lua 784: ~/.config/nvim-Lazyman/lua/keymaps.lua:148>
                 Toggle Line Numbers
 Last set from Lua
n  ,uw         * <Lua 785: ~/.config/nvim-Lazyman/lua/keymaps.lua:147>
                 Toggle Word Wrap
 Last set from Lua
n  ,us         * <Lua 786: ~/.config/nvim-Lazyman/lua/keymaps.lua:146>
                 Toggle Spelling
 Last set from Lua
...
n  ,fn         * <Cmd>enew<CR>
                 New File
 Last set from Lua
n  ,k          * <Lua 787: ~/.config/nvim-Lazyman/lua/keymaps.lua:120>
                 toggle signature
 Last set from Lua
...
n  ,xX         * <Cmd>TroubleToggle workspace_diagnostics<CR>
 ...
 Last set from Lua
n  ,dt         * <Lua 507: ~/.config/nvim-Lazyman/lua/config/lspconfig.lua:89>
                 Toggle diagnostics
 Last set from Lua
n  ,dq         * <Lua 506: ~/.local/share/nvim/runtime/lua/vim/diagnostic.lua:1527>
                 Set diagnostics location list
 Last set from Lua
n  ,de         * <Lua 470: ~/.local/share/nvim/runtime/lua/vim/diagnostic.lua:1272>
                 Open float
 Last set from Lua
n  ,cm         * <Cmd>Mason<CR>
                 Mason
 Last set from Lua
n  ,ut         * <Lua 222: ~/.config/nvim-Lazyman/lua/themes/tokyonight.lua:82>
                 Toggle Transparency
 Last set from Lua
n  ,tj         * <Lua 154: ~/.local/share/nvim-Lazyman/lazy/lazy.nvim/lua/lazy/core/handler/keys.lua:67>
                 Treesitter Join
 Last set from Lua
n  ,tt         * <Lua 145: ~/.local/share/nvim-Lazyman/lazy/lazy.nvim/lua/lazy/core/handler/keys.lua:67>
                 Toggle Treesitter Join
 Last set from Lua
n  ,ts         * <Lua 144: ~/.local/share/nvim-Lazyman/lazy/lazy.nvim/lua/lazy/core/handler/keys.lua:67>
                 Treesitter Split
 Last set from Lua
n  ,D          * <Lua 143: ~/.local/share/nvim-Lazyman/lazy/lazy.nvim/lua/lazy/core/handler/keys.lua:67>
                 Close Buffer
 Last set from Lua
n  ,e          * <Lua 138: ~/.local/share/nvim-Lazyman/lazy/lazy.nvim/lua/lazy/core/handler/keys.lua:67>
                 Explorer (root dir)
 Last set from Lua
n  ,E          * <Lua 135: ~/.local/share/nvim-Lazyman/lazy/lazy.nvim/lua/lazy/core/handler/keys.lua:67>
                 Explorer Float
 Last set from Lua
n  <aÞ         * <Nop>
 Last set from Lua
...
n  [b          * <Cmd>bprevious<CR>
                 Prev buffer
 Last set from Lua
n  [t          * <Lua 167: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:283>
                 Previous todo comment
 Last set from Lua
n  [[          * <Lua 599: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:188>
                 Prev Reference
 Last set from Lua
n  [q          * <Lua 178: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:251>
...
n  [d          * <Lua 471: ~/.local/share/nvim/runtime/lua/vim/diagnostic.lua:807>
 Last set from Lua
n  ]Þ          * <Nop>
 Last set from Lua
n  ]           * <Cmd>lua require("which-key").show("]", {mode = "n", auto = true})<CR>
...
n  ]b          * <Cmd>bnext<CR>
                 Next buffer
 Last set from Lua
n  ]t          * <Lua 159: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:282>
                 Next todo comment
 Last set from Lua
n  ]]          * <Lua 598: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:188>
                 Next Reference
 Last set from Lua
n  ]q          * <Lua 177: ~/.config/nvim-Lazyman/lua/plugins/editor.lua:262>
...
n  ]d          * <Lua 505: ~/.local/share/nvim/runtime/lua/vim/diagnostic.lua:853>
 Last set from Lua
n  `           * <Cmd>lua require("which-key").show("`", {mode = "n", auto = true})<CR>
 Last set from Lua
x  aÞ          * <Nop>
...
s  <C-F>       * <Lua 976: ~/.local/share/nvim-Lazyman/lazy/nvim-cmp/lua/cmp/utils/keymap.lua:127>
                 cmp.utils.keymap.set_map
 Last set from Lua
s  <C-B>       * <Lua 990: ~/.local/share/nvim-Lazyman/lazy/nvim-cmp/lua/cmp/utils/keymap.lua:127>
                 cmp.utils.keymap.set_map
 Last set from Lua
...
n  <C-D>       * <Cmd>lua require('neoscroll').scroll(vim.wo.scroll, true, 250)<CR>
 Last set from Lua
n  <Plug>(nvim-surround-change) * <Lua 194: ~/.local/share/nvim-Lazyman/lazy/nvim-surround/lua/nvim-surround/init.lua:181>
                 Change a surrounding pair
 Last set from Lua
n  <Plug>(nvim-surround-delete) * <Lua 655: ~/.local/share/nvim-Lazyman/lazy/nvim-surround/lua/nvim-surround/init.lua:148>
                 Delete a surrounding pair
 Last set from Lua
...
x  <Plug>(nvim-surround-visual) * <Esc><Cmd>lua require'nvim-surround'.visual_surround({ line_mode = false })<CR>
                 Add a surrounding pair around a visual selection
 Last set from Lua
n  <Plug>(nvim-surround-normal-cur-line) * <Lua 199: ~/.local/share/nvim-Lazyman/lazy/nvim-surround/lua/nvim-surround/config.lua:665>
                 Add a surrounding pair around the current line, on new lines (normal mode)
 Last set from Lua
n  <Plug>(nvim-surround-normal-line) * <Lua 206: ~/.local/share/nvim-Lazyman/lazy/nvim-surround/lua/nvim-surround/config.lua:652>
                 Add a surrounding pair around a motion, on new lines (normal mode)
 Last set from Lua
n  <Plug>(nvim-surround-normal-cur) * <Lua 212: ~/.local/share/nvim-Lazyman/lazy/nvim-surround/lua/nvim-surround/config.lua:639>
                 Add a surrounding pair around the current line (normal mode)
 Last set from Lua
n  <Plug>(nvim-surround-normal) * <Lua 223: ~/.local/share/nvim-Lazyman/lazy/nvim-surround/lua/nvim-surround/config.lua:626>
                 Add a surrounding pair around a motion (normal mode)
 Last set from Lua
n  <C-W>Þ      * <Nop>
 Last set from Lua
...
n  <C-6>       * <C-^>
 Last set from Lua
x  <M-i>       * <Lua 595: ~/.local/share/nvim-Lazyman/lazy/vim-illuminate/lua/illuminate.lua:292>
 Last set from Lua line 45
o  <M-i>       * <Lua 594: ~/.local/share/nvim-Lazyman/lazy/vim-illuminate/lua/illuminate.lua:292>
 Last set from Lua line 45
n  <M-p>       * <Lua 593: ~/.local/share/nvim-Lazyman/lazy/vim-illuminate/lua/illuminate.lua:285>
                 Move to previous reference
 Last set from Lua line 45
n  <M-n>       * <Lua 571: ~/.local/share/nvim-Lazyman/lazy/vim-illuminate/lua/illuminate.lua:278>
...
s  <Plug>luasnip-jump-prev * <Lua 424: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:57>
 Last set from Lua
s  <Plug>luasnip-jump-next * <Lua 423: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:54>
 Last set from Lua
s  <Plug>luasnip-prev-choice * <Lua 422: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:51>
 Last set from Lua
s  <Plug>luasnip-next-choice * <Lua 421: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:48>
 Last set from Lua
s  <Plug>luasnip-expand-snippet * <Lua 420: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:45>
 Last set from Lua
s  <Plug>luasnip-expand-or-jump * <Lua 419: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:42>
 Last set from Lua
   <Plug>luasnip-expand-repeat * <Lua 417: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:35>
 Last set from Lua
n  <Plug>luasnip-delete-check * <Lua 415: ~/.local/share/nvim-Lazyman/lazy/LuaSnip/plugin/luasnip.lua:28>
 Last set from Lua
s  <S-Tab>     * <Lua 1014: ~/.local/share/nvim-Lazyman/lazy/nvim-cmp/lua/cmp/utils/keymap.lua:127>
                 cmp.utils.keymap.set_map
 Last set from Lua
