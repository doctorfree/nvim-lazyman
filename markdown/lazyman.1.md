...
lazyman [-A] [-a] [-b branch] [-c] [-d] [-e] [-E config] [-i] [-k] [-l] [-m] [-s] [-S] [-v] [-n] [-p] [-P] [-q] [-I] [-L cmd] [-rR] [-C url] [-D subdir] [-N nvimdir] [-U] [-w conf] [-W] [-x conf] [-X] [-y] [-z] [-Z] [-u]
...
`-w conf` : indicates install and initialize Extra 'conf' configuration. 'conf' can be one of: 'Abstract', 'Allaman', 'Fennel', 'Nv', 'NvPak', 'Optixal', 'Plug', or 'Heiker'
