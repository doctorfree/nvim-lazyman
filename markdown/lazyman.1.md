...
lazyman [-A] [-a] [-B] [-b branch] [-c] [-d] [-e] [-E config] [-f path] [-F] [-g] [-i] [-j] [-k] [-l] [-m] [-M] [-s] [-S] [-v] [-n] [-p] [-P] [-q] [-Q] [-h] [-H] [-I] [-L cmd] [-rR] [-C url] [-D subdir] [-N nvimdir] [-T] [-U] [-w conf] [-W] [-x conf] [-X] [-y] [-Y] [-z] [-Z] [-u] [install] [open] [remove] [status]
...
`-x conf` : indicates install and initialize nvim-starter 'conf' configuration. 'conf' can be one of: 'Basic', 'Kickstart', 'NvPak', 'Minimal', 'StartBase', 'Opinion', 'Lsp', 'Mason', or 'Modular'
