...
`-x conf` : indicates install and initialize nvim-starter 'conf' configuration. 'conf' can be one of: 'Basic', 'Kickstart', 'NvPak', 'PDE', 'Minimal', 'StartBase', 'Opinion', 'Lsp', 'Mason', or 'Modular'
