...
`-w conf` : indicates install and initialize Personal 'conf' configuration. 'conf' can be one of: All 3rd Adib Brain Charles Craftzdog Daniel Dillon Elianiva Elijah Enrique Heiker J4de Josean Kodo LvimAdib Maddison Metis Mini ONNO OnMyWay Optixal Rafi Roiz Simple Slydragonn Spider Traap xero Xiao
